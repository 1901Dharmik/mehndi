            ...
            <div className="relative flex h-16 items-center justify-between">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                ...
                <Disclosure.Button className="relative inline-flex items-center justify-center rounded-md p-2 text-red-800 " >
                  ...
                  {open ? (
                    <XMarkIcon className="block h-10 w-10 border-2 rounded-md border-gray-200" aria-hidden="true" ></XMarkIcon>
                  ) : (
                    <Bars3Icon className="block h-10 w-10 border-2 rounded-md border-gray-200" aria-hidden="true" 
            ...
            <div className="space-y-1 px-2 pb-3 pt-2">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  // href={item.href}
                  className={classNames(
                    item.current ? 'bg-gray-200 text-red-700 text-bold ' : 'text-black-300 hover:bg-gray-200 hover:text-red-800',
